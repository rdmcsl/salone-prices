...
SAMPLE_PRICE_ROWS = {
    ...
    "groundnut":    [["2024-04-28", "bo",       350,   "Ibrahim Sesay"],
                     ["2024-04-28", "freetown", 380,   "Fatmata Koroma"]],
    "tomato":       [["2024-04-28", "freetown", 120,   "Fatmata Koroma"],
                     ["2024-04-28", "bo",       100,   "Ibrahim Sesay"]],
    "maize":        [["2024-04-28", "bo",       280,   "Ibrahim Sesay"],
                     ["2024-04-28", "kenema",   260,   "Alhaji Bangura"]],
    "fish_bonga":   [["2024-04-28", "freetown", 8500,  "Fatmata Koroma"],
                     ["2024-04-28", "bo",       8000,  "Ibrahim Sesay"]],
    "onion":        [["2024-04-28", "freetown", 150,   "Fatmata Koroma"],
                     ["2024-04-28", "bo",       130,   "Ibrahim Sesay"]],
    "cooking_oil":  [["2024-04-28", "freetown", 1500,  "Fatmata Koroma"],
                     ["2024-04-28", "bo",       1400,  "Ibrahim Sesay"]],
    "salt":         [["2024-04-28", "freetown", 45,    "Fatmata Koroma"],
                     ["2024-04-28", "bo",       40,    "Ibrahim Sesay"]],
    "pepper":       [["2024-04-28", "freetown", 200,   "Fatmata Koroma"],
                     ["2024-04-28", "kenema",   180,   "Alhaji Bangura"]],
    "sweet_potato": [["2024-04-28", "bo",       90,    "Ibrahim Sesay"],
                     ["2024-04-28", "freetown", 100,   "Fatmata Koroma"]],
}
